...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/columns/master/_listings/google-analytics/apis.md
specificationVersion: "0.14"
apis:
- name: Google Analytics - Get Columsn
  x-api-slug: metadatareporttypecolumns-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/columns/master/_listings/google-analytics/metadatareporttypecolumns-get-openapi.md
- name: Google Analytics - Get Columsn
  x-api-slug: metadatareporttypecolumns-get
  description: Lists all columns for a report type
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/logo_lockup_analytics_icon_vertical_black_2x.png
