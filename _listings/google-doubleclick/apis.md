...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/columns/master/_listings/google-doubleclick/apis.md
...
- name: Google Doubleclick Merged API - Get Saved Columns
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/columns/master/_listings/google-doubleclick/agencyagencyidadvertiseradvertiseridsavedcolumns-get-openapi.md
- name: Google Doubleclick Merged API - Get Saved Columns
  x-api-slug: agencyagencyidadvertiseradvertiseridsavedcolumns-get
  description: Retrieve the list of saved columns for a specified advertiser.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/google-double-click.png
